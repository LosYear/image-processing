    ...
    return (
      <section className="expandable-container">
        <div
          ...
          onClick={() => this.setState({ ...this.state, expanded: !expanded })}
        >
        ...
        <div
          ...
          style={{
            maxHeight: expanded
              ? this.refs.container && this.refs.container.scrollHeight
              : 0
          }}
          ref="container"
        >
          <div className="expandable-container__content-wrapper">
            {this.props.children}
          </div>
        </div>
      </section>
